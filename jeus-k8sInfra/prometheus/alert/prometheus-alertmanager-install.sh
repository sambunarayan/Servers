...
--set server.baseURL="http://192.168.2.13" \
--set server.service.loadBalancerIP="192.168.2.13" \
...
--set alertmanager.service.loadBalancerIP="192.168.2.15" \
--set alertmanager.baseURL="http://192.168.2.15" \
-f ~/Servers/jeus-k8sInfra/prometheus/alert/values.yaml